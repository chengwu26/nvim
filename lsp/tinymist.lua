...
local function create_tinymist_command(command_name, client, bufnr)
  ...
  local cmd_name = export_type and ("TinymistExport" .. cmd_display) or ---@type string
      ("Tinymist" .. cmd_display)
  local cmd_desc = export_type and ("Export to " .. cmd_display) or ---@type string
      ("Get " .. cmd_display)
